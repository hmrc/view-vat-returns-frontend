...
yourVatReturn.finalReturn = Ffurflen TAW derfynol
yourVatReturn.additionalInfo = Gwybodaeth ychwanegol
yourVatReturn.boxOne = Blwch 1
yourVatReturn.boxOneDescription = TAW a godwyd gennych ar werthiannau a chyflenwadau eraill
yourVatReturn.boxOneDescription.niProtocol = TAW sy’n ddyledus yn y cyfnod ar werthiannau ac allbynnau eraill
yourVatReturn.boxTwo = Blwch 2
yourVatReturn.boxTwoDescription = TAW sydd arnoch ar nwyddau a brynwyd o wledydd y GE ac y daethpwyd â nhw i mewn i’r DU
yourVatReturn.boxTwoDescription.niProtocol = TAW sy’n ddyledus yn y cyfnod ar gaffael nwyddau a wneir yng Ngogledd Iwerddon o Aelod-wladwriaethau’r UE
yourVatReturn.boxThree = Blwch 3
yourVatReturn.boxThreeDescription = TAW sydd arnoch cyn didyniadau (dyma gyfanswm blwch 1 a 2)
yourVatReturn.boxThreeDescription.niProtocol = Cyfanswm y TAW sy’n ddyledus (dyma gyfanswm blychau 1 a 2)
yourVatReturn.boxFour = Blwch 4
yourVatReturn.boxFourDescription = TAW yr ydych wedi’i hawlio’n ôl
yourVatReturn.boxFourDescription.niProtocol = TAW a adenillwyd yn y cyfnod ar bryniadau a mewnbynnau eraill (gan gynnwys caffaeliadau yng Ngogledd Iwerddon o Aelod-wladwriaethau’r UE)
yourVatReturn.boxFive = Blwch 5
yourVatReturn.boxFiveDescription = Cyfanswm y Ffurflen TAW
yourVatReturn.boxFiveDescription.niProtocol = TAW net i dalu i CThEM neu ei hadennill (dyma’r gwahaniaeth rhwng blychau 3 a 4)
...
yourVatReturn.boxSeven = Blwch 7
yourVatReturn.boxSevenDescription = Cyfanswm gwerth pryniannau a threuliau eraill, ac eithrio TAW
yourVatReturn.boxSevenDescription.niProtocol = Cyfanswm gwerth y pryniadau a’r holl fewnbynnau eraill, heb gynnwys TAW
yourVatReturn.boxEight = Blwch 8
yourVatReturn.boxEightDescription = Cyfanswm gwerth nwyddau a gyflenwyd i wledydd y GE a chostau perthynol (ac eithrio TAW)
yourVatReturn.boxEightDescription.niProtocol = Cyfanswm gwerth anfon y nwyddau a’r costau cysylltiedig (ac eithrio TAW) o Ogledd Iwerddon i Aelod-wladwriaethau’r UE 
yourVatReturn.boxNine = Blwch 9
...
yourVatReturn.boxNineDescription.niProtocol = Cyfanswm gwerth caffael y nwyddau a’r costau cysylltiedig (ac eithrio TAW) a wneir yng Ngogledd Iwerddon o Aelod-wladwriaethau’r UE 
...
returnDeadlines.periodEnding = ar gyfer y cyfnod {0}
returnDeadlines.howToSubmit = Sut i gyflwyno Ffurflen TAW
returnDeadlines.softwareOne = Dewis meddalwedd cyfrifyddu sy’n cefnogi’r gwasanaeth hwn (yn agor mewn tab newydd)
returnDeadlines.softwareTwo = os nad ydych wedi gwneud yn barod.
returnDeadlines.vatRecords = Cadw’ch cofnodion TAW yn eich meddalwedd cyfrifyddu.
returnDeadlines.sendReturns = Cyflwyno unrhyw Ffurflenni TAW cyn eich dyddiadau cau.
returnDeadlines.nextDeadline = Bydd eich dyddiad cau nesaf yn ymddangos yma ar ddiwrnod cyntaf eich cyfnod cyfrifyddu nesaf.
